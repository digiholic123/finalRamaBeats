!function(e) {
    ...
    a.prototype.createLineChart=function(e, a, r, t, i, o, b, s, y) {
        Morris.Line( {
            element: e, data: a, xkey: r, ykeys: t, labels: i, fillOpacity: o, pointFillColors: b, pointStrokeColors: s, behaveLikeLine: !0, gridLineColor: "#eef0f2", hideHover: "auto", lineWidth: "3px", pointSize: 0, preUnits: "$ ", resize: !0, lineColors: y
        }
        )
    }
    ,
    a.prototype.createAreaChart=function(e, a, r, t, i, o, b, s) {
        Morris.Area( {
            element: e, pointSize: 0, lineWidth: 0, data: t, xkey: i, ykeys: o, labels: b, hideHover: "auto", resize: !0, gridLineColor: "#eef0f2", lineColors: s
        }
        )
    }
    ,
    a.prototype.createAreaChartDotted=function(e, a, r, t, i, o, b, s, y, l) {
        Morris.Area( {
            element: e, pointSize: 3, lineWidth: 1, data: t, xkey: i, ykeys: o, labels: b, hideHover: "auto", pointFillColors: s, pointStrokeColors: y, resize: !0, gridLineColor: "#eef0f2", lineColors: l
        }
        )
    }
    ,
    a.prototype.createBarChart=function(e, a, r, t, i, o) {
        Morris.Bar( {
            element: e, data: a, xkey: r, ykeys: t, labels: i, hideHover: "auto", resize: !0, gridLineColor: "#eeeeee", barSizeRatio: .4, barColors: o
        }
        )
    }
    ,
